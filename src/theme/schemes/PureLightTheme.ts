...
export const PureLightTheme = createTheme({
        ...
        MuiCssBaseline: {
            styleOverrides: {
                'html, body': {
                    width: '100%',
                    height: '100%',
                    fontFamily: `${montserrat.style.fontFamily}, -apple-system, "Apple Color Emoji", "Segoe UI Emoji"`,
                },
                ...
                'table th .Mui-active .MuiTableSortLabel-icon': {
                    stroke: 'rgba(34, 51, 84, 0.7)',
                    'stroke-width': '2px',
                },
                'table th .MuiTableSortLabel-icon': {
                    opacity: '1',
                    color: 'rgba(34, 51, 84, 0.7)',
                },
                '.ck.ck-balloon-panel': {
                    zIndex: '11111 !important',
                    boxShadow: 'rgba(255, 255, 255, 0.3) 0px 1rem 2rem 0px, rgba(0, 0, 0, 0.11) 0px 0.1rem 1.3rem, rgba(0, 0, 0, 0.08) 0px 0.1rem 0.2rem',
                ...
                '.ck.ck-dropdown.ck-heading-dropdown .ck-dropdown__panel': {
                    left: '0px !important',
                ...
                '.mention__item.ck-button:hover': {
                    backgroundColor: '#dddddd !important'
                },
                '.mention__item.ck-button img': {
                    flexBasis: '40px',
                    alignItems: 'center',
                    borderRadius: '5px',
                    overflow: 'hidden',
                },
                '.mention___item__more-info': {
                    width: 'calc(100% - 40px) !important',
                    paddingLeft: '10px !important',
                    display: 'flex',
                    flexDirection: 'column'
                },
                '.mention___item__full-name': {
                ...
                '.MuiBackdrop-root': {
                    'background-color': 'rgb(0 7 52 / 0%) !important',
    ...
    typography: {
        fontFamily:
            `${montserrat.style.fontFamily}, -apple-system, "Apple Color Emoji", "Segoe UI Emoji"`,
        h1: {
            fontWeight: 700,
            fontSize: 35
        },
