...
import { ActionsWrapper, AddGuestWrapper, ContentInput, GridField, IconButtonAddGuest, IconButtonGuest, ListInvitedUsers, TextVisibleAddGuest, TextVisibleUserInfo, TextVisibleUserName } from "./calendar-content-style";
import { CalendarEvent } from "../../../models/Calendar/CalendarEvent";
import { ICalendarEventForm } from "../../../models/Calendar/CalendarEventForm";
...
const AddEventCalendarPopup: FC<IAddEventCalendarPopupProps> = ({isPermissionAction, formCalendarEvent, currentEvent, onSubmit}): JSX.Element => {
    ...
    const [dataUsersGuest, setDataUsersGuest] = useState<IUser[]>();

    const [dataUsersGuestTemp, setDataUsersGuestTemp] = useState<IUser[]>();
